...
DATASET_PATH   = f'{PROJECT_DIR}/filtered_dataset.zip'            # (filtered images + CSVs)
DATASET_DIR    = f'{PROJECT_DIR}/filtered_dataset'                        # filtered dataset (uncompressed)
KAGGLE_DIR     = f'{PROJECT_DIR}/dataset'                        # temporal download of the original dataset to then be filtered and moved to DATASET_DIR in 01_dataset_import.ipynb

MODELS_DIR     = f'{PROJECT_DIR}/models'                           # saved models

MAPS_PATH      = f'{PROJECT_DIR}/grad_cam_maps.zip'               # Grad-CAM maps
